  ...
  return (
    ...
    >
      ...
      {label}
        ...
        {isSearch && (
            <kbd className="ml-auto pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-monotext-[10px] text-muted-foreground opacity-100">
        ...
        {!!id && (
            <div className="ml-auto flex items-center gap-x-2">
                ...
                rounded-sm h-full ml-auto text-muted-foreground hover:bg-neutral-300 dark:hover:bg-neutral-600">
